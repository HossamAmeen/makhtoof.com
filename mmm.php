    ...
    <script type="text/javascript">
        ...
        function initMap() {
          ...
          var legend = document.getElementById('mapLegend');
            ...
            div.innerHTML = '<span><img src="https://maps.google.com/mapfiles/ms/icons/green-dot.png"> ����� ����� </span>';
            legend.appendChild(div);
            var div = document.createElement('div');
            div.innerHTML = '<span><img src="https://maps.google.com/mapfiles/kml/shapes/library_maps.png"> ����� ����� </span>';
            legend.appendChild(div);
            div= document.createElement('div');
            div.innerHTML = '<span><img src="https://developers.google.com/maps/documentation/javascript/examples/full/images/beachflag.png"> �� ���� ������</span>';
            legend.appendChild(div);
