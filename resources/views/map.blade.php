...
@section('content')
    ...
    <script type="text/javascript">
        ...
        function initMap() {
            ...
            div.innerHTML = '<span><img src="http://maps.google.com/mapfiles/ms/icons/green-dot.png"> مفقود اعرفه </span>';
            legend.appendChild(div);
            var div = document.createElement('div');
            div.innerHTML = '<span><img src="https://maps.google.com/mapfiles/kml/shapes/library_maps.png"> ايجاد مفقود </span>';
            legend.appendChild(div);
            div= document.createElement('div');
            div.innerHTML = '<span><img src="https://developers.google.com/maps/documentation/javascript/examples/full/images/beachflag.png"> عن نفسى كمفقود</span>';
            legend.appendChild(div);
    ...
    * The callback parameter executes the initMap() function
    -->
    <script async defer
            src="https://maps.googleapis.com/maps/api/js?key=AIzaSyDmxfCV_Ri6AfKdaSpZwiAVz9hxpPOB5Y4&callback=initMap">
    </script>
    </body>
    @foreach($home as $h)
    @endforeach
