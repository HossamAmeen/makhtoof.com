                                    ...
                                    <table class="table table-striped table-bordered table-hover"
                                        ...
                                        @if(count($admin)>0)
                                            ...
                                            <tr>
                                                ...
                                                <td width="30%">
                                                    <span class="tbl-data"> {{$ad->email}} </span>
                                                </td>
                                                <td width="35%">
                                                    <div class="form-group row-option">
                                                        <button type="button" value="{{$ad->id}},{{$ad->firstName}},{{$ad->lastName}},{{$ad->email}} "  id="editt" class="btn btn-primary options-admin-btn"
                    ...
                    {{csrf_field()}}
                        <script type="text/javascript"> 
                            $("button").click(function() {
                                ...
                                var name = res[1]+" "+res[2];
                                document.getElementById('xyz').value=res[0];
