                                            ...
                                            <tr>
                                                ...
                                                <td width="30%">
                                                    <div class="form-group row-option">
                                                        <button type="button" id="usr" value="{{$post->id}},{{$post->name}},{{$post->age}},{{$post->gender}},{{$post->blood_type}},{{$post->governate}},{{$post->city}},{{$post->street}},{{$post->other_info}},{{$post->url}},{{$user}}" class="btn btn-primary options-admin-btn"
        ...
        <div class="modal fade" id="viewPost" tabindex="-1" role="dialog" aria-labelledby="basicModal"
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    <script type="text/javascript"> $("button#usr").click(function() { var fired_button = $(this).val(); var res = fired_button.split(",");
                            ...
                            var usrfn=res[11].split(":")[1];
                            var usrln=res[12].split(":")[1];
                            var usremail=res[14].split(":")[1];
                            var usrphone=res[17].split(":")[1];
                            var usrgender=res[18].split(":")[1];
                            var usrgov=res[15].split(":")[1];
                            var usrcity=res[16].split(":")[1];
                            usrname=usrfn+usrln;
                            document.getElementById('usrname').innerHTML = usrname;
                                document.getElementById('usremail').innerHTML = usremail;
                                    document.getElementById('usrphone').innerHTML = usrphone;
                                        document.getElementById('usrgender').innerHTML =usrgender;
                                            document.getElementById('usrgov').innerHTML =usrgov;
                                                document.getElementById('usrcity').innerHTML =usrcity;
                        }); </script>
                    ...
                    <form>
                        ...
                        <div class="modal-body post-body">
                                <div class="row">
                                        <div class="col-lg-5">
                                            <p><b>الاسم : </b><span id="usrname"></span></p>
                                        </div>
                                        <div class="col-lg-7">
                                    ...
                                    <div class="row">
                                        <div class="col-lg-12">
                                            <p><b>رقم التليفون : </b><span id="usrphone"></span></p>
                                        </div>
                                    </div>
                                    <hr>  
                            <div class="row">
